...
- [x] **Phase 1: Legacy Liquidation**: Remove all `.jsx` templates and unused test JSON files.
- [x] **Phase 1.5: Dependency Purge**: Move backend/heavy libraries (Puppeteer, MongoDB, Express) to `devDependencies` to protect bundle size.
- [x] **Phase 2: Semantic Retrofit**: Update 2025 components (starting with 25-04-25) to use the `<time>` tag and CSS Modules.
