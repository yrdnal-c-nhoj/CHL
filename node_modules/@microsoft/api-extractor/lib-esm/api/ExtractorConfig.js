...
import { JsonFile, JsonSchema, FileSystem, Objects, PackageJsonLookup, PackageName, Text, InternalError, Path, NewlineKind } from '@rushstack/node-core-library';
...
export class ExtractorConfig {
    ...
    static loadFile(jsonFilePath) {
        ...
        configObject = Objects.mergeWith(structuredClone(ExtractorConfig._defaultConfig), configObject, mergeCustomizer);
