import{r as s,j as e}from"./index-CVcA385j.js";const m="/assets/iss-zB-a6Iar.ttf",u=()=>{const[n,i]=s.useState(new Date);s.useEffect(()=>{const r=setInterval(()=>i(new Date),1e3);return()=>clearInterval(r)},[]);const o=r=>String(r).padStart(2,"0").split(""),[a,p]=o(n.getHours()),[l,c]=o(n.getMinutes()),[x,f]=o(n.getSeconds()),t={fontFace:`
      @font-face {
        font-family: 'iss';
