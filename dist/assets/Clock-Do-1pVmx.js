import{r as w,j as e}from"./index-9yDBTM3Q.js";const y="/assets/watch-BIS26Q5f.ttf",j="/assets/gears-13950_128-BKyKeb4M.gif",k=()=>{w.useEffect(()=>{const d={0:"zero",1:"one",2:"two",3:"three",4:"four",5:"five",6:"six",7:"seven",8:"eight",9:"nine"},s=i=>i.split("").map(t=>d[t]||t),r=()=>{const i=new Date;let t=i.getHours();const u=i.getMinutes(),g=i.getSeconds();t=t%12||12;const x=s(String(t)),h=s(String(u).padStart(2,"0")),m=s(String(g).padStart(2,"0")),o=(v,p)=>{const a=document.querySelector(`#${v} .value`);a&&(a.innerHTML="",p.forEach(f=>{const c=document.createElement("span");c.className="digit-box",c.textContent=f,a.appendChild(c)}))};o("hours",x),o("minutes",h),o("seconds",m)},l=setInterval(r,1e3);return r(),()=>clearInterval(l)},[]);const n={position:"fixed",width:"100%",height:"100%",top:0,left:0,backgroundImage:`url(${j})`,backgroundRepeat:"repeat",backgroundPosition:"center",pointerEvents:"none"};return e.jsxs("div",{style:{height:"100dvh",width:"100vw",display:"flex",justifyContent:"center",alignItems:"center",position:"relative",overflow:"hidden",backgroundColor:"#c9dbef",margin:0,padding:0},children:[e.jsx("style",{children:`
        @font-face {
          font-family: 'watch';
