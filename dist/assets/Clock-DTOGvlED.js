import{r as a,j as e}from"./index-D5DjY_nl.js";const c="/assets/orb-CYB_IVAf.ttf",g="/assets/cinz-BEUupow3.ttf",j=()=>{const[u,h]=a.useState(""),[f,p]=a.useState(""),[o,b]=a.useState(!1),[y,l]=a.useState(!1),s=a.useRef(null);a.useEffect(()=>{const t=new Date().getTime(),n=document.createElement("style");n.textContent=`
      @font-face {
