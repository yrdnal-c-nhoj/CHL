import{r as n,j as e}from"./index-_Zh6IFgu.js";const y="/assets/watch-BIS26Q5f.ttf",b="/assets/gears-13950_128-BKyKeb4M.gif",k=()=>{const[r,d]=n.useState(!1),[l,u]=n.useState([]),[x,g]=n.useState([]),[h,v]=n.useState([]),[m,p]=n.useState(window.innerHeight),f={0:"zero",1:"one",2:"two",3:"three",4:"four",5:"five",6:"six",7:"seven",8:"eight",9:"nine"},o=t=>t.split("").map(i=>f[i]||i);if(n.useEffect(()=>{const t=()=>p(window.innerHeight);return window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]),n.useEffect(()=>{const t=()=>{const s=new Date;let c=s.getHours()%12||12;const w=String(s.getMinutes()).padStart(2,"0"),j=String(s.getSeconds()).padStart(2,"0");u(o(String(c))),g(o(w)),v(o(j))};(async()=>{try{const s=new FontFace("watch",`url(${y})`);await s.load(),document.fonts.add(s),t(),d(!0);const c=setInterval(t,1e3);return()=>clearInterval(c)}catch(s){console.error("Font failed to load",s)}})()},[]),!r)return null;const a={position:"fixed",width:"100%",height:"100%",top:0,left:0,backgroundImage:`url(${b})`,backgroundRepeat:"repeat",backgroundPosition:"center",pointerEvents:"none"};return e.jsxs("div",{style:{height:m,width:"100vw",display:"flex",justifyContent:"center",alignItems:"center",position:"relative",overflow:"hidden",backgroundColor:"#c9dbef",margin:0,padding:0},children:[e.jsx("style",{children:`
        .clock {
