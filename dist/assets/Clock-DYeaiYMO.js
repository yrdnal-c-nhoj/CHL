import{r as s,j as n}from"./index-5HPYteOP.js";const b="/assets/dots-T_wUUQTL.otf",v="/assets/dot-CG13gqB0.jpg";function S(){const[d,a]=s.useState(new Date),[r,l]=s.useState(window.innerWidth<600);s.useEffect(()=>{const t=()=>{l(window.innerWidth<600)};window.addEventListener("resize",t);const e=setInterval(()=>{a(new Date)},1e3);return()=>{clearInterval(e),window.removeEventListener("resize",t)}},[]);const c=t=>{let e=t.getHours();const i=String(t.getMinutes()).padStart(2,"0"),w=String(t.getSeconds()).padStart(2,"0");return e=e%12||12,e=e.toString(),{hours:e,minutes:i,seconds:w}},{hours:g,minutes:p,seconds:h}=c(d),x={display:"flex",justifyContent:"center",alignItems:"center",height:"100vh",width:"100vw",flexDirection:r?"column":"row",gap:"0.1rem",overflow:"hidden"},f={display:"flex",flexDirection:"row",gap:"0.1rem",alignItems:"center",justifyContent:"center"},m={width:"9rem",height:"9rem",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"11rem",fontFamily:"'dots', monospace",backgroundColor:"rgba(251, 148, 5, 0.1)",borderRadius:"0.2em",color:"rgb(4, 2, 109)",textShadow:`
      #f6320b 1px 1px 20px,
      #94f00b -1px 1px 20px,
      #f72808 1px -1px 20px,
      #a5f507 -1px -1px 20px
