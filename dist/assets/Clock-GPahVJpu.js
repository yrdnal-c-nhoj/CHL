import{r as a,j as t}from"./index-9yDBTM3Q.js";const p="/assets/suv-BE9Vq26Y.ttf",h="/assets/suv-CBvsV9zK.gif",b="/assets/suvx-CIoEUrQS.jpg",k=()=>{const[s,i]=a.useState({h:"00",m:"00",ampm:"AM"});a.useEffect(()=>{new FontFace("suv",`url(${p})`).load().then(n=>{document.fonts.add(n)});const o=()=>{const n=new Date;let e=n.getHours();const u=n.getMinutes(),f=e>=12?"PM":"AM";e=e%12,e=e||12,i({h:String(e).padStart(2,"0"),m:String(u).padStart(2,"0"),ampm:f})};o();const m=setInterval(o,1e3);return()=>clearInterval(m)},[]);const l={margin:0,height:"100dvh",width:"100vw",display:"flex",justifyContent:"flex-start",alignItems:"flex-start",background:"#7E8280FF",fontFamily:"suv, sans-serif",padding:"0vw",boxSizing:"border-box",overflow:"hidden"},d={position:"fixed",left:"200px",top:"51vh",transform:"translateY(-50%)",display:"flex",textAlign:"left",zIndex:2,lineHeight:1,gap:"0rem"},r={fontFamily:"suv, sans-serif",display:"block",fontSize:"1.1rem",color:"transparent",backgroundImage:`
      linear-gradient(
        145deg,
        #ffffff 0%,
        #d0d0d0 25%,
