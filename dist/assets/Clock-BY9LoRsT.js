import{r as a,j as e}from"./index-BREfQhwF.js";const g="/assets/mu-BtVGLSAE.jpg",p="/assets/mult-DNXazs0y.ttf",h=()=>{const[i,c]=a.useState("");a.useEffect(()=>{const s=()=>{const r=new Date;let t=r.getHours();const o=r.getMinutes();t=t%12||12;const u=t<10?"0"+t:t,d=o<10?"0"+o:o;c(`${u}${d}`)};s();const m=setInterval(s,1e3);return()=>clearInterval(m)},[]);const l=`
    @font-face {
      font-family: 'mult';
