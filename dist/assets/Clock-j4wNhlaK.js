import{r as o,j as t}from"./index-DhGayC4d.js";const c="/assets/stt-CQAc0zfY.ttf";function m(){const[a,n]=o.useState([]);function r(){const e=new Date,i=e.getHours().toString().padStart(2,"0"),d=e.getMinutes().toString().padStart(2,"0");return(i+d).split("")}o.useEffect(()=>{n(r());const e=setInterval(()=>n(r()),1e3);return()=>clearInterval(e)},[]);const s=`
    linear-gradient(
      0deg,
