import{r as n,j as e}from"./index-DuxRGnoV.js";const S=()=>{const[f,b]=n.useState(new Date),[a,p]=n.useState(!1),[r,u]=n.useState(!1),s=`ultraFont${new Date().getTime()}`;n.useEffect(()=>{const t=()=>{u(window.innerWidth<=768)};return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]),n.useEffect(()=>{const t=document.createElement("style");return t.textContent=`
      @font-face {
        font-family: '${s}';
