import{r,j as e}from"./index-pvgtSMk9.js";const h="/assets/bone-jCxhOO-o.ttf",p="/assets/bone-vAIxiEPy.png",b="/assets/bone1-BBkEdZA4.png",x="/assets/bone2-DfHxgggE.png",y="/assets/bon-Cewn0iE2.png",I=()=>{const i=r.useRef(null),l=r.useRef(null),c=r.useRef(null),g=r.useRef(null);return r.useEffect(()=>{const d=()=>{const s=new Date,o=s.getSeconds(),n=s.getMinutes(),a=s.getHours(),m=o*6,f=n*6+o*.1,t=a%12*30+n*.5;c.current&&(c.current.style.transform=`translateX(-50%) rotate(${m}deg)`),l.current&&(l.current.style.transform=`translateX(-50%) rotate(${f}deg)`),i.current&&(i.current.style.transform=`translateX(-50%) rotate(${t}deg)`)};(()=>{const s=g.current;if(!s)return;const o=45;for(let n=1;n<=12;n++){const a=(n-3)*30*(Math.PI/180),m=50+o*Math.cos(a),f=50+o*Math.sin(a),t=document.createElement("span");t.textContent=n,t.style.position="absolute",t.style.left=`${m}%`,t.style.top=`${f}%`,t.style.transform="translate(-50%, -50%)",t.style.fontSize="5.5rem",t.style.fontFamily="bone, sans-serif",t.style.color="rgb(223, 213, 187)",t.style.textShadow="#1b1b1a 1px 1px 0px, #141412 -1px -1px 0px",s.appendChild(t)}})(),d();const u=setInterval(d,1e3);return()=>clearInterval(u)},[]),e.jsxs("div",{style:{margin:0,padding:0,background:"#757272",height:"100vh",width:"100vw",display:"flex",justifyContent:"center",alignItems:"center"},children:[e.jsx("style",{children:`
        @font-face {
          font-family: 'bone';
