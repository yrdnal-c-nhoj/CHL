import{r as n,j as t}from"./index-BG825qbX.js";const p="/assets/bg-ClhUlRZs.jpg",S="/assets/baud-9AONKx7j.ttf",w=()=>{const[f,x]=n.useState(new Date),[l,d]=n.useState(!1);n.useEffect(()=>{const e=setInterval(()=>x(new Date),1e3);return()=>clearInterval(e)},[]),n.useEffect(()=>{const e=document.createElement("style");e.textContent=`
      @font-face {
