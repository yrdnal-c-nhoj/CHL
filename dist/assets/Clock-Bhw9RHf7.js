import{r as c,j as l}from"./index-Dhx6LE5Y.js";const S="/assets/back-DH1ui0sU.ttf",C=()=>{const f=["h0","h1","m0","m1","s0","s1"],u=c.useRef({}),o=c.useRef({}),g=c.useRef({}),h=c.useRef({}),m=c.useRef({});return c.useEffect(()=>{const a=document.createElement("style");a.textContent=`
      @font-face {
        font-family: 'back';
