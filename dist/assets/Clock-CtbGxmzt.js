import{r as c,j as e}from"./index-B5PGV64Y.js";const h="/assets/3ce69531311986a8a78f1e093f53df3d-ezgif.com-optiwebp-CmcgD_uY.webp",p=()=>(c.useEffect(()=>{const r=()=>{const a=new Date,t=a.getSeconds(),n=a.getMinutes(),s=a.getHours(),i=t/60*360,d=n/60*360+t/60*6,l=s%12/12*360+n/60*30;document.querySelector(".second-hand").style.transform=`translateX(-50%) rotate(${i}deg)`,document.querySelector(".minute-hand").style.transform=`translateX(-50%) rotate(${d}deg)`,document.querySelector(".hour-hand").style.transform=`translateX(-50%) rotate(${l}deg)`};r();const o=setInterval(r,1e3);return()=>clearInterval(o)},[]),e.jsxs("div",{style:{position:"relative",width:"100vw",height:"100vh",overflow:"hidden"},children:[e.jsx("img",{src:h,alt:"background",className:"full-page-image"}),e.jsx("div",{className:"clock",children:e.jsx("div",{id:"radar",children:e.jsxs("div",{className:"clock-face",children:[e.jsx("div",{className:"hand hour-hand"}),e.jsx("div",{className:"hand minute-hand"}),e.jsx("div",{className:"hand second-hand"}),e.jsx("div",{className:"center"})]})})}),e.jsx("style",{children:`
        :root {
          --g: rgb(14, 238, 14);
          --bg-lines: rgb(2, 67, 2);
          --bg-screen: #000100;
