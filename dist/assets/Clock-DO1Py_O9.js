import{r as p,j as t}from"./index-DbecJIRO.js";const f="/assets/cas-r-PHYe5m.ttf",g="/assets/ap-BNH6PGuf.jpeg",h=()=>{p.useEffect(()=>{const i=document.createElement("style");i.textContent=`
      @font-face {
    ...
    `,document.head.appendChild(i);const n=()=>{const a=new Date;let r=a.getHours();r=r%12||12,r=String(r).padStart(2,"0");const o=String(a.getMinutes()).padStart(2,"0"),d=String(a.getSeconds()).padStart(2,"0"),l=`${r}${o}${d}`;document.querySelectorAll(".piece").forEach((c,m)=>{c.setAttribute("data-digit",l[m])})};n();const s=setInterval(n,1e3);return()=>{clearInterval(s),document.head.removeChild(i)}},[]);const e={pendulumApp:{height:"100dvh",margin:0,display:"flex",justifyContent:"center",alignItems:"center",flexDirection:"column",position:"relative",overflow:"hidden"},bgLayer:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:`url(${g}) no-repeat center center fixed`,backgroundSize:"cover",filter:"contrast(0.8) brightness(0.5) saturate(1.6)",zIndex:0},pendulum:{display:"flex",borderStyle:"solid",borderWidth:"1vw 1vw 3vw 1vw",borderRadius:"3.25vw 3.25vw 0 0",padding:"0 4.5vw 2.25vw",height:"26vw",zIndex:1,borderImage:"linear-gradient(145deg, #b08d57, #f6e27a, #b08d57, #8c6b32) 1",borderImageSlice:1,backgroundColor:"transparent",boxShadow:`
