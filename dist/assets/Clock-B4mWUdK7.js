import{r as o,j as t}from"./index-D70hTCHv.js";const d="/assets/hori-B_RXP1B6.otf",c="/assets/4c558c5dbff1828f2b87582dc49526e8-C3H_XxIx.gif",f="/assets/sdfwef-RBVpXVS6.gif",h="/assets/ewfsdfsd-CsK_7g8W.gif",g=()=>{const[r,l]=o.useState("");return o.useEffect(()=>{const i=()=>{const s=new Date;let e=s.getHours();const a=String(s.getMinutes()).padStart(2,"0");e=e%12,e===0&&(e=12),l(`${e}${a}`)};i();const n=setInterval(i,1e3);return()=>clearInterval(n)},[]),t.jsxs("div",{style:{width:"100vw",height:"100vh",margin:0},children:[t.jsx("style",{children:`
          @font-face {
