import{r as n,j as e}from"./index-DbecJIRO.js";const S=()=>{const[f,b]=n.useState(new Date),[a,p]=n.useState(!1),[r,u]=n.useState(!1),s=`ultraFont${new Date().getTime()}`;n.useEffect(()=>{const t=()=>{u(window.innerWidth<=768)};return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]),n.useEffect(()=>{const t=document.createElement("style");return t.textContent=`
      @font-face {
        font-family: '${s}';
    ...
    `,document.head.appendChild(t),(async()=>{await new Promise(d=>setTimeout(d,2500)),p(!0)})(),()=>{document.head.contains(t)&&document.head.removeChild(t)}},[s]),n.useEffect(()=>{if(!a)return;const t=setInterval(()=>{b(new Date)},1e3);return()=>clearInterval(t)},[a]);const x=t=>{let o=t.getHours();const d=t.getMinutes(),k=t.getSeconds();return o=o%12||12,{hours:o.toString().padStart(2,"0"),minutes:d.toString().padStart(2,"0"),seconds:k.toString().padStart(2,"0")}},{hours:c,minutes:g,seconds:m}=x(f),i={display:"inline-block",fontFamily:`${s}, 'JetBrains Mono', 'SF Mono', Menlo, Monaco, Consolas, monospace`,fontWeight:"900",fontSize:r?"5vw":"6vw",lineHeight:"0.85",color:"#ffffff",textAlign:"center",background:`
    ...
    `,filter:"brightness(1.15) contrast(1.3) saturate(1.4)",animation:"float 7s ease-in-out infinite, rainbow-glow 6s ease-in-out infinite"},y={width:"100vw",height:"100vh",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",background:a?`
    ...
    `:"#000000",backgroundSize:"500% 500%, 500% 500%, 500% 500%, 500% 500%, 100% 100%",backgroundBlendMode:"overlay, soft-light, color-dodge, multiply, normal",margin:0,padding:0,overflow:"hidden",position:"relative",animation:a?"aurora 25s ease-in-out infinite, fadeIn 4s ease-out":"none"},h={display:"flex",flexDirection:r?"column":"row",alignItems:"center",justifyContent:"center",gap:r?"1.5rem":"2rem",position:"relative",zIndex:10,animation:a?"entrance 2.5s cubic-bezier(0.175, 0.885, 0.32, 1.275) 1.5s both":"none",transform:"translateZ(0)",perspective:"1200px"},l={display:"flex",alignItems:"center",justifyContent:"center",position:"relative",transform:"translateZ(60px)",animation:"group-float 9s ease-in-out infinite"},w={position:"absolute",top:0,left:0,right:0,bottom:0,opacity:.2,background:`
    ...
    `,backgroundSize:"350px 350px, 300px 300px, 450px 450px, 400px 400px, 250px 250px, 320px 320px, 280px 280px",animation:"cosmic-drift 35s linear infinite, twinkle 3s ease-in-out infinite"},v={position:"absolute",top:0,left:0,right:0,bottom:0,background:`
    ...
    `,animation:"aurora-sweep 15s ease-in-out infinite",zIndex:2};return a?e.jsxs("div",{style:y,children:[e.jsx("div",{style:w}),e.jsx("div",{style:v}),e.jsxs("div",{style:h,children:[e.jsxs("div",{style:{...l,animationDelay:"0s"},children:[e.jsx("div",{style:{...i,animationDelay:"0.1s"},children:c[0]}),e.jsx("div",{style:{...i,animationDelay:"0.2s"},children:c[1]})]}),e.jsxs("div",{style:{...l,animationDelay:"1.2s"},children:[e.jsx("div",{style:{...i,animationDelay:"0.3s"},children:g[0]}),e.jsx("div",{style:{...i,animationDelay:"0.4s"},children:g[1]})]}),e.jsxs("div",{style:{...l,animationDelay:"2.4s"},children:[e.jsx("div",{style:{...i,animationDelay:"0.5s"},children:m[0]}),e.jsx("div",{style:{...i,animationDelay:"0.6s"},children:m[1]})]})]}),e.jsx("style",{children:`
        @keyframes aurora {
