import{r as i,j as t}from"./index-_Zh6IFgu.js";const et="/assets/disc-DCr12WMC.ttf",O="/assets/water-aTLIImM6.webp",S="/assets/disc-DKRtrneP.gif",nt=()=>{const[l,T]=i.useState(new Date),[h,P]=i.useState(!1);if(i.useEffect(()=>{const e=document.createElement("style");return e.textContent=`
      @font-face {
