import{r as a,j as t}from"./index-5HPYteOP.js";const y="/assets/cloudy-Pg9CFaLp.ttf",g="/assets/cmoon-DQfv1cJj.webp",h="/assets/clou-BEkIAWB9.gif",r="/assets/clll-DJTnwkss.webp",b=()=>{const e=a.useRef();a.useEffect(()=>{const o=document.createElement("style");o.textContent=`
      @font-face {
        font-family: 'cloudy';
        src: url(${y}) format('truetype');
      }
    `,document.head.appendChild(o);const n=()=>{const s=new Date;let m=s.getHours()%12||12;const p=String(s.getMinutes()).padStart(2,"0");e.current.textContent=`${m}:${p}`},f=setInterval(n,1e3);return n(),()=>clearInterval(f)},[]);const i={margin:0,overflow:"hidden",background:"linear-gradient(to bottom, #1d1d4f, #182c21)",height:"100vh",width:"100vw",display:"flex",justifyContent:"center",alignItems:"center",position:"relative"},c={position:"absolute",left:"50%",top:"120vh",width:"22vh",height:"22vh",backgroundImage:`url(${g})`,backgroundSize:"cover",backgroundPosition:"center",display:"flex",justifyContent:"center",alignItems:"center",transform:"translateX(-50%)",animation:"moonRise 15s infinite ease-in-out",zIndex:5},l={fontFamily:"cloudy, sans-serif",fontSize:"3.5rem",color:"#f9f6c2",textShadow:`
