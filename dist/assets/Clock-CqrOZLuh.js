import{r as o,j as e}from"./index-CB5Z5zkF.js";const d="/assets/brai-BProws7r.ttf",f=()=>{const[t,c]=o.useState(new Date);o.useEffect(()=>{const a=setInterval(()=>c(new Date),1e3);return()=>clearInterval(a)},[]);const s=a=>a.toString().padStart(2,"0"),i=s(t.getHours()),n=s(t.getMinutes()),r=s(t.getSeconds()),l=`
    @font-face {
      font-family: 'brai';
