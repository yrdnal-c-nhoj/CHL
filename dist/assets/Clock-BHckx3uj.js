import{r as s,j as x}from"./index-BG825qbX.js";const o="/assets/sha-DFlnkQrJ.ttf",h=()=>{const[p,a]=s.useState({hours:"00",minutes:"00",seconds:"00"});s.useEffect(()=>{const n=()=>{const t=new Date;a({hours:String(t.getHours()).padStart(2,"0"),minutes:String(t.getMinutes()).padStart(2,"0"),seconds:String(t.getSeconds()).padStart(2,"0")})},i=setInterval(n,1e3);return n(),()=>clearInterval(i)},[]);const c=`
    @font-face {
      font-family: 'sha';
      src: url(${o}) format('truetype');
    }
  `,r={margin:0,height:"100dvh",width:"100%",display:"flex",justifyContent:"center",alignItems:"center",backgroundColor:"#FFFFFF",flexDirection:"column",fontFamily:"sha"},d={display:"flex",flexDirection:window.innerWidth>=768?"row":"column",alignItems:"center",justifyContent:"center",textAlign:"center",maxWidth:"90vw",letterSpacing:"0.15em",color:"#000000",textShadow:`
