import{r as o,j as t}from"./index-Bshzq55w.js";const c="/assets/hori-B_RXP1B6.otf",f="/assets/4c558c5dbff1828f2b87582dc49526e8-C3H_XxIx.gif",h="/assets/sdfwef-RBVpXVS6.gif",x="/assets/ewfsdfsd-CsK_7g8W.gif",m=()=>{const[r,l]=o.useState("");return o.useEffect(()=>{const e=()=>{const n=new Date;let i=n.getHours();const a=String(n.getMinutes()).padStart(2,"0");i=i%12,i===0&&(i=12);const d=`${i}${a}`;l(d)};e();const s=setInterval(e,1e3);return()=>clearInterval(s)},[]),t.jsxs("div",{style:{width:"100vw",height:"100vh",margin:0},children:[t.jsx("style",{children:`
          @font-face {
