import{r as I,j as n}from"./index-CGhn_q7G.js";const j="/assets/kla-e4sVwpHZ.webp",F="/assets/klax-DRSXN1QX.png",z="/assets/klaxon-C7GY-biL.png",C="/assets/kla-AZCilWpQ.png",H="/assets/klax-_ZDNIFwR.ttf",S=["xii","i","ii","iii","iv","v","vi","vii","viii","ix","x","xi"],M=()=>(I.useEffect(()=>{const u=document.createElement("style");u.textContent=`
      @font-face {
        font-family: 'klax';
