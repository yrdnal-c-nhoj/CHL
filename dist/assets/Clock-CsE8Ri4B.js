import{r,j as l}from"./index-DhGayC4d.js";const y="/assets/d1-2MawacXN.ttf",S="/assets/d2-HcI7PgNu.ttf",E="/assets/d3-5yatceUt.otf";function M(){const[o,u]=r.useState({h:0,m:0,s:0}),[c,m]=r.useState(!1);r.useEffect(()=>{const e=()=>{document.documentElement.style.setProperty("--vh",`${window.innerHeight*.01}px`)};return e(),window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[]),r.useEffect(()=>{const e=document.createElement("style");e.textContent=`
    ...
    0 0 4vh #00FFE5FF,
    0 0 6vh #84FF00FF
  `:"0 0 0.8vh rgba(25, 10, 80)",opacity:s?1:.4,transition:"all 0.4s ease",pointerEvents:"none",whiteSpace:"nowrap",zIndex:s?10:1},children:i},`${t}-${n}`))}return h};return c?(`${o.h.toString().padStart(2,"0")}${o.m.toString().padStart(2,"0")}${o.s.toString().padStart(2,"0")}`,l.jsx("div",{style:{position:"fixed",inset:0,width:"100vw",height:"calc(var(--vh, 1vh) * 100)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"flex-start",background:"radial-gradient(circle at center, #530B7CFF 30%, #6B11BAFF 100%)",overflow:"hidden"},children:l.jsxs("div",{style:{position:"relative",width:"100vh",height:"100vh"},children:[F(12,62,"h",{x:-77,y:-54}),F(60,139,"m",{x:-147,y:-20}),F(60,72,"s",{x:-75,y:9})]})})):null}export{M as default};
