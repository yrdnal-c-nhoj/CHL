import{r as I,j as n}from"./index-CxO71aJe.js";const j="/assets/kla-e4sVwpHZ.webp",z="/assets/klax-DRSXN1QX.png",F="/assets/klaxon-C7GY-biL.png",S="/assets/kla-AZCilWpQ.png",C="/assets/klax-_ZDNIFwR.ttf",H="/assets/klax-BT3JXp4B.webp",M=["xii","i","ii","iii","iv","v","vi","vii","viii","ix","x","xi"],$=()=>(I.useEffect(()=>{const u=document.createElement("style");u.textContent=`
      @font-face {
        font-family: 'klax';
