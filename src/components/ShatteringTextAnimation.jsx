...
const ShatteringTextAnimation = () => {
  ...
  useEffect(() => {
    ...
    // Create timeline with animation options
    ...
    // Hover handlers for slow motion effect
  ...
  return (
    <div className="shattering-text-container">
      <style jsx>{`
        ...
        .shattering-text-container:hover::after {
...
export default ShatteringTextAnimation;
