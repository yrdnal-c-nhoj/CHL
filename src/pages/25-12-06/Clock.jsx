...
// import minuteHandImg from './hand1.gif' // file missing
...
export default function AnalogClock () {
  ...
  const calculatedVerticalTileCount =
    Math.ceil(viewport.height / tileSizePx) + 1
  ...
  const handStyle = (deg, width, height, transitionDuration) => ({
    ...
    zIndex: 10,
    filter:
      'drop-shadow(2px 2px 2px rgba(0,0,0,0.9)) drop-shadow(-2px -2px 2px rgba(255,255,255,0.7))',
    maskImage:
      'linear-gradient(to top, rgba(0,0,0,0) 0%, rgba(0,0,0,0) 3%, rgba(0,0,0,1) 5%)',
    WebkitMaskImage:
      'linear-gradient(to top, rgba(0,0,0,0) 0%, rgba(0,0,0,0) 3%, rgba(0,0,0,1) 5%)',
    opacity: 0.8
  })
  ...
  return (
    <div style={outerContainerStyle}>
      ...
      <div style={clockContainerStyle}>
        ...
        {/* Minute hand commented out due to missing asset */}
        {/* <img
          src={minuteHandImg}
          alt='minute'
