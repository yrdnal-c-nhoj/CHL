...
function loadAllDigitImages() {
  const globs = {
    0: import.meta.glob("../../../assets/images/26-01/26-01-04/0/*.{png,jpg,jpeg,gif,webp}", { eager: true, as: "url" }),
    1: import.meta.glob("../../../assets/images/26-01/26-01-04/1/*.{png,jpg,jpeg,gif,webp}", { eager: true, as: "url" }),
    2: import.meta.glob("../../../assets/images/26-01/26-01-04/2/*.{png,jpg,jpeg,gif,webp}", { eager: true, as: "url" }),
    3: import.meta.glob("../../../assets/images/26-01/26-01-04/3/*.{png,jpg,jpeg,gif,webp}", { eager: true, as: "url" }),
    4: import.meta.glob("../../../assets/images/26-01/26-01-04/4/*.{png,jpg,jpeg,gif,webp}", { eager: true, as: "url" }),
    5: import.meta.glob("../../../assets/images/26-01/26-01-04/5/*.{png,jpg,jpeg,gif,webp}", { eager: true, as: "url" }),
    6: import.meta.glob("../../../assets/images/26-01/26-01-04/6/*.{png,jpg,jpeg,gif,webp}", { eager: true, as: "url" }),
    7: import.meta.glob("../../../assets/images/26-01/26-01-04/7/*.{png,jpg,jpeg,gif,webp}", { eager: true, as: "url" }),
    8: import.meta.glob("../../../assets/images/26-01/26-01-04/8/*.{png,jpg,jpeg,gif,webp}", { eager: true, as: "url" }),
    9: import.meta.glob("../../../assets/images/26-01/26-01-04/9/*.{png,jpg,jpeg,gif,webp}", { eager: true, as: "url" }),
  };
