...
// --- Image Imports ---
import bg2 from '../../../assets/images/26-01/26-01-11/flam4.webp';
import bg1 from '../../../assets/images/26-01/26-01-11/flaa.webp';
import fontflam251211 from '../../../assets/fonts/26-01-11-flam.ttf';
import hourHandImg from '../../../assets/images/26-01/26-01-11/leg1.webp';
import minuteHandImg from '../../../assets/images/26-01/26-01-11/leg2.webp';
import secondHandImg from '../../../assets/images/26-01/26-01-11/flam.webp';
...
const ClockHand = memo(({ img, height, rotation, flip, reverse, zIndex }) => (
  <img
    ...
    style={{
      ...
      */
      WebkitMaskImage:
        'linear-gradient(to top, rgba(0,0,0,0.1) 0%, rgba(0,0,0,1) 50%)',
      maskImage:
        'linear-gradient(to top, rgba(0,0,0,0.1) 0%, rgba(0,0,0,1) 50%)',
