...
const CLOCK_NUMBERS = [
  { num: '12', top: '5%', left: '50%' }, { num: '1', top: '16%', left: '78%' },
  { num: '2', top: '30%', left: '89%' }, { num: '3', top: '50%', left: '95%' },
  { num: '4', top: '70%', left: '89%' }, { num: '5', top: '84%', left: '78%' },
  { num: '6', top: '94%', left: '50%' }, { num: '7', top: '84%', left: '22%' },
  { num: '8', top: '70%', left: '11%' }, { num: '9', top: '50%', left: '5%' },
  { num: '10', top: '30%', left: '11%' }, { num: '11', top: '16%', left: '22%' }
];
    ...
    <div style={{
      ...
      <div className="clock" style={{
        ...
        <div className="hand hour-hand" style={{
          ...
          borderRadius: '4.8rem', transformOrigin: 'bottom center',
        ...
        <div className="hand minute-hand" style={{
          ...
          borderRadius: '4.3rem', transformOrigin: 'bottom center',
