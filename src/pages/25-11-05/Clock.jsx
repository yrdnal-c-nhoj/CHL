...
const WebFonnov25ufuf = '../../assets/fonts/25-11-05-webs1.ttf';
const Webfont2511055 = '../../assets/fonts/25-11-05-webs2.ttf';
const w251105font = '../../assets/fonts/25-11-05-webs3.ttf';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span>Safe Area • </span>
          <span style={{ fontFamily: DIGIT_TYPEFACE }}>
            {SAFE_INSET_H}VW × {SAFE_INSET_V}VH Inset
          </span>
        </div>
      </div>
      ...
      {breakpoints.map(bp => (
        ...
        >
          ...
          >
            <span>{bp.name} </span>
            <span style={{ fontFamily: DIGIT_TYPEFACE }}>
              {Math.round(bp.width * (viewportWidth / 100))}PX
            </span>
          </div>
        </div>
      ))}
      ...
      {[
        ...
        >
          ...
          >
            ...
            <span style={{ fontFamily: DIGIT_TYPEFACE }}>
              {Math.round(height * (viewportHeight / 100))}PX
            </span>
          </div>
        </div>
      ))}
      ...
      >
        <span>
          {COLUMNS} Column Grid • {GUTTER}VW Gutter •{' '}
        </span>
