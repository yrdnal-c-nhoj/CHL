...
import topoImage from '../../../assets/images/25-12/25-12-25/topo.jpg';
...
const TOP_AIRPORTS = [
  { city: 'London', code: 'LHR', lat: 51.47, lon: -0.4543 },
  ...
  { city: 'Hong Kong', code: 'HKG', lat: 22.308, lon: 113.9185 },
  ...
  { city: 'Bangkok', code: 'BKK', lat: 13.69, lon: 100.7501 },
  ...
  { city: 'San Francisco', code: 'SFO', lat: 37.6189, lon: -122.375 },
  ...
  { city: 'Las Vegas', code: 'LAS', lat: 36.084, lon: -115.1537 },
  { city: 'Miami', code: 'MIA', lat: 25.7959, lon: -80.287 },
  { city: 'Orlando', code: 'MCO', lat: 28.4312, lon: -81.308 },
  ...
  { city: 'Charlotte', code: 'CLT', lat: 35.214, lon: -80.9431 },
  ...
  { city: 'Copenhagen', code: 'CPH', lat: 55.618, lon: 12.656 },
  ...
  { city: 'Prague', code: 'PRG', lat: 50.1008, lon: 14.26 },
  ...
  { city: 'Alicante', code: 'ALC', lat: 38.278, lon: -0.561 },
  { city: 'Gran Canaria', code: 'LPA', lat: 27.9318, lon: -15.3862 },
  { city: 'Tenerife', code: 'TFS', lat: 28.045, lon: -16.5725 },
  { city: 'Cancun', code: 'CUN', lat: 21.0388, lon: -86.8746 },
  { city: 'Los Cabos', code: 'SJD', lat: 23.1541, lon: -109.921 },
  { city: 'Puerto Vallarta', code: 'PVR', lat: 20.6808, lon: -105.2618 },
  { city: 'Montreal', code: 'YUL', lat: 45.4706, lon: -73.741 },
  ...
  { city: 'Winnipeg', code: 'YWG', lat: 49.9095, lon: -97.236 },
  { city: 'Kelowna', code: 'YLW', lat: 49.9511, lon: -119.375 },
  ...
  { city: 'Glasgow', code: 'GLA', lat: 55.872, lon: -4.4319 },
  ...
  { city: 'Kerry', code: 'KIR', lat: 52.16, lon: -9.3967 },
  ...
  { city: 'Bern', code: 'BRN', lat: 46.9, lon: 7.487 },
  { city: 'Lucerne', code: 'LCE', lat: 47.0589, lon: 8.3058 },
  { city: 'St. Gallen', code: 'ACH', lat: 47.4645, lon: 9.38 },
  { city: 'Innsbruck', code: 'INN', lat: 47.2624, lon: 11.3429 },
  { city: 'Salzburg', code: 'SZG', lat: 47.7927, lon: 13.006 },
  ...
  { city: 'Karlsruhe', code: 'FKB', lat: 48.7797, lon: 8.099 },
  { city: 'Saarbrucken', code: 'SCN', lat: 49.2325, lon: 7.1134 },
  { city: 'Rostock', code: 'RLG', lat: 54.0899, lon: 12.087 },
  { city: 'Erfurt', code: 'ERF', lat: 50.9801, lon: 11.0333 },
  { city: 'Bologna', code: 'BLQ', lat: 44.5391, lon: 11.279 },
  { city: 'Florence', code: 'FLR', lat: 43.7848, lon: 11.258 },
  ...
  { city: 'Bari', code: 'BRI', lat: 41.14, lon: 16.7644 },
  ...
  { city: 'Charleroi', code: 'CRL', lat: 50.4614, lon: 4.451 },
  { city: 'Antwerp', code: 'ANR', lat: 51.1853, lon: 4.4639 },
  { city: 'Liege', code: 'LGG', lat: 50.637, lon: 5.4437 },
  { city: 'Namur', code: 'QNU', lat: 50.4578, lon: 4.872 },
  { city: 'Bruges', code: 'BZY', lat: 51.1975, lon: 3.2256 },
  { city: 'Ghent', code: 'GNE', lat: 51.0381, lon: 3.728 },
  ...
  { city: 'Eindhoven', code: 'EIN', lat: 51.4494, lon: 5.375 },
  ...
  { city: 'Leeuwarden', code: 'LWR', lat: 53.2194, lon: 5.795 },
  ...
  { city: 'Roskilde', code: 'RKE', lat: 55.62, lon: 12.0847 },
  ...
  { city: 'Skive', code: 'SQW', lat: 56.59, lon: 9.1606 },
  ...
  { city: 'Lund', code: 'LUG', lat: 55.7169, lon: 13.19 },
  ...
  { city: 'Tromsø', code: 'TOS', lat: 69.6811, lon: 18.915 },
  { city: 'Ålesund', code: 'AES', lat: 62.562, lon: 6.1289 },
  { city: 'Bodø', code: 'BOO', lat: 67.2803, lon: 14.3989 },
  { city: 'Molde', code: 'MOL', lat: 62.7344, lon: 7.275 },
  { city: 'Haugesund', code: 'HAU', lat: 59.4322, lon: 5.25 },
  { city: 'Sandefjord', code: 'TRF', lat: 59.1689, lon: 10.225 },
  { city: 'Skien', code: 'SKE', lat: 59.2089, lon: 9.6089 },
  { city: 'Fredrikstad', code: 'FRED', lat: 59.2228, lon: 10.95 },
  { city: 'Drammen', code: 'DRA', lat: 59.7444, lon: 10.2039 },
  { city: 'Larvik', code: 'LAR', lat: 59.0689, lon: 10.05 },
  ...
  { city: 'Vaasa', code: 'VAA', lat: 63.07, lon: 21.75 },
  { city: 'Kuopio', code: 'KUO', lat: 62.8925, lon: 27.7022 },
  { city: 'Jyväskylä', code: 'JYV', lat: 62.4019, lon: 25.67 },
  { city: 'Pori', code: 'POR', lat: 61.475, lon: 21.7989 },
  { city: 'Lahti', code: 'LHT', lat: 60.98, lon: 25.6625 },
  ...
  { city: 'Mikkeli', code: 'MIK', lat: 61.69, lon: 27.2667 },
  { city: 'Savonlinna', code: 'SVL', lat: 61.9333, lon: 28.95 },
  { city: 'Kajaani', code: 'KAJ', lat: 64.2297, lon: 27.7247 },
  { city: 'Lappeenranta', code: 'LPP', lat: 61.04, lon: 28.1889 },
  ...
  { city: 'Osijek', code: 'OSI', lat: 45.55, lon: 18.7 },
  { city: 'Zadar', code: 'ZAD', lat: 44.1189, lon: 15.3589 },
  { city: 'Pula', code: 'PUY', lat: 44.8667, lon: 13.85 },
  { city: 'Šibenik', code: 'SJJ', lat: 43.7333, lon: 15.9 },
  { city: 'Varaždin', code: 'VAR', lat: 46.3, lon: 16.35 },
  { city: 'Slavonski Brod', code: 'SLO', lat: 45.6667, lon: 18.0167 },
  { city: 'Gospić', code: 'GOS', lat: 44.45, lon: 15.0667 },
  { city: 'Karlovac', code: 'KLV', lat: 45.4833, lon: 15.55 },
  { city: 'Virovitica', code: 'VIV', lat: 45.8333, lon: 17.3833 },
  { city: 'Bjelovar', code: 'BJE', lat: 45.75, lon: 16.8333 },
  { city: 'Sisak', code: 'SIK', lat: 45.5, lon: 16.35 },
  { city: 'Split', code: 'SPU', lat: 43.5467, lon: 16.2611 },
  { city: 'Dubrovnik', code: 'DBV', lat: 42.8917, lon: 18.2644 },
  { city: 'Rijeka', code: 'RJK', lat: 45.2172, lon: 14.5808 },
  { city: 'Osijek', code: 'OSI', lat: 45.55, lon: 18.7 },
...
const generateTopographicSVG = () => {
  ...
  for (let i = 0; i < lines; i++) {
    ...
    for (let x = 0; x <= width; x += 20) {
      const yOffset =
        Math.sin((x / width) * Math.PI * 2 + Math.random()) *
        10 *
        Math.random();
