...
const abuVideo = '/assets/media/26-02-27-abu.mp4';
...
const Clock: React.FC = () => {
  ...
  const handStyle = (
    ...
    transition:
      type === 'second'
        ? 'none'
        : 'transform 0.5s cubic-bezier(0.4, 2.1, 0.5, 0.5)',
      ...
      >
          ...
          return (
            <div
              ...
              style={{
                ...
                fontFamily:
                  "'Noto Sans Egyptian Hieroglyphs', 'Peralta', sans-serif",
                color: '#E2C264',
        ...
        <div
          style={{
            ...
            height: '28px',
            background:
              'radial-gradient(circle, #F3F2EB 0%, #E2C264 40%, #86641A 100%)',
            borderRadius: '50%',
            zIndex: 25,
