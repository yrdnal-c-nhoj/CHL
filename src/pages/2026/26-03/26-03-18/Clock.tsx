    ...
    return (
        ...
        `}
            ...
            >
                ...
                <div
                    className="hollywood-glow"
                    style={{
                        position: 'absolute',
                        top: '50%',
                        left: '50%',
                        width: `${8 * handScale}px`,
                        height: `${100 * handScale}px`,
          ...
          `,
                ...
                <div
                    ...
                    style={{
                        ...
                        top: '50%',
                        left: '50%',
                        width: `${4 * handScale}px`,
                        height: `${140 * handScale}px`,
          ...
          `,
                ...
                <div
                    ...
                    style={{
                        ...
                        top: '50%',
                        left: '50%',
                        width: `${2 * handScale}px`,
                        height: `${160 * handScale}px`,
          ...
          `,
                ...
                <div
                    style={{
                        ...
                        top: '50%',
                        left: '50%',
                        width: `${60 * handScale}px`,
                        height: `${60 * handScale}px`,
