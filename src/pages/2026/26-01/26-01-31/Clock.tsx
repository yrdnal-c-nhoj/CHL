...
import rainBg from '@/assets/images/26_images/26-01/26-01-31/lu.webp';
import lemGif from '@/assets/images/26_images/26-01/26-01-31/lemslo.gif';
import lemons2Bg from '@/assets/images/26_images/26-01/26-01-31/lemons2.jpg';
import centerImage from '@/assets/images/26_images/26-01/26-01-31/lem.gif';
...
const SimpleBackground: React.FC = () => {
  ...
  const cells = useMemo(() => {
    ...
    h = h % 12 || 12;
    return [
      h.toString().padStart(2, '0')[0],
      h.toString().padStart(2, '0')[1],
      time.getMinutes().toString().padStart(2, '0')[0],
      time.getMinutes().toString().padStart(2, '0')[1],
      time.getSeconds().toString().padStart(2, '0')[0],
      time.getSeconds().toString().padStart(2, '0')[1],
