...
import font20250119_secondary from '@/assets/fonts/2025/25-04-25-Oswald-Bold.ttf?url';
import font20250119_mono from '@/assets/fonts/2025/25-05-10-Questrial.ttf?url';
    ...
    >
      ...
      >
        ...
        <header style={{ textAlign: 'center', padding: '0 1rem' }}>
          ...
          >
            A <strong>leap second</strong> is a one-second adjustment keeping
            UTC synchronized with Earth's rotation.
          </div>
          <div
            style={{
        ...
        >
          ...
          <div style={{ display: 'flex', opacity: 0.4 }}>
            <DigitBox>
              {now.getMinutes().toString().padStart(2, '0')[0]}
            </DigitBox>
            <DigitBox>
              {now.getMinutes().toString().padStart(2, '0')[1]}
            </DigitBox>
          </div>
          <div style={{ display: 'flex', opacity: 0.6 }}>
            <DigitBox>
              {now.getSeconds().toString().padStart(2, '0')[0]}
            </DigitBox>
            <DigitBox>
              {now.getSeconds().toString().padStart(2, '0')[1]}
            </DigitBox>
          </div>
        ...
        <footer style={{ width: '100%' }}>
          ...
          >
            Cubist Heart Laboratories salutes the tireless work of the
