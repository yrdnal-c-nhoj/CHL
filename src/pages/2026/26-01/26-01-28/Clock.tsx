...
function useClockAngles() {
    ...
    return useMemo(() => {
        ...
        const s: Record<string, React.CSSProperties> = now.getSeconds() + ms / 1000;
...
const Clock: React.FC<ClockProps> = ({
    ...
    const transitionStyle: React.CSSProperties = smooth
...
const ThreeSingleHandClocks: React.FC = () => {
...
export default ThreeSingleHandClocks;
