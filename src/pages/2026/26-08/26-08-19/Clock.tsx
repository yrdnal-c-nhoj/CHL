  ...
  return (
    ...
    >
      ...
      <div className={styles.digitalClock}>
        <span className={styles.digit}>{digitalTime.hours[0]}</span>
        <span className={styles.digit}>{digitalTime.hours[1]}</span>
        <span className={styles.colon}>:</span>
        <span className={styles.digit}>{digitalTime.minutes[0]}</span>
        <span className={styles.digit}>{digitalTime.minutes[1]}</span>
        <span className={styles.colon}>:</span>
        <span className={styles.digit}>{digitalTime.seconds[0]}</span>
        <span className={styles.digit}>{digitalTime.seconds[1]}</span>
      </div>
    </main>
  );
};
