...
import Cube from '../../26-08-01/Cube';
import Pyramid from '../../26-08-01/Pyramid';
import Sphere from '../../26-08-01/Sphere';
...
export const assets: string[] = [
  // Add any specific assets for this clock here if needed
];
