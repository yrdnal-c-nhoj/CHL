...
import bottomBackgroundImg from '../../../assets/images/25-10/25-10-11/ch.jpg'; // New bottom background image
import backgroundImg from '../../../assets/images/25-10/25-10-11/ches.jpg'; // Original background image
...
export default function FancyClock() {
  ...
  const [alphabetFontLoaded, setAlphabetFontLoaded] = useState<boolean>(false);
  ...
  useEffect(() => {
    const font = new FontFace(
      'CustomFont20251011',
      `url(${customFont20251011})`,
    );
    font.load().then((loaded) => {
      document.fonts.add(loaded);
      setFontLoaded(true);
    });
    const alphaFont = new FontFace(
      'AlphabetFont20251011',
      `url(${alphabetFont20251011})`,
    );
