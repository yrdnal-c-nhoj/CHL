...
import blackImg from '../../../assets/images/25-10/25-10-19/tile1.jpg'; // "1" squares
import pinkImg from '../../../assets/images/25-10/25-10-19/tile2.jpg'; // "0" squares
...
const DIGITS = {
  ...
  1: Array(GRID_SIZE)
    ...
    .map((_, r) =>
      Array(GRID_SIZE)
        .fill(0)
        .map((_, c) => (c === Math.floor(GRID_SIZE / 2) ? 1 : 0)),
    ),
  2: Array(GRID_SIZE)
    .fill(0)
    .map((_, r) =>
  ...
  7: Array(GRID_SIZE)
    ...
    .map((_, r) =>
      Array(GRID_SIZE)
        .fill(0)
        .map((_, c) => (r === 0 || c === GRID_SIZE - 1 - r ? 1 : 0)),
    ),
  8: Array(GRID_SIZE)
    .fill(0)
    .map((_, r) =>
