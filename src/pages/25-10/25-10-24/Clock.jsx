...
import cornerUL from '../../../assets/images/25-10/25-10-24/ul.webp';
import cornerLR from '../../../assets/images/25-10/25-10-24/lr.webp';
...
export default function VictorianEsperantoClock() {
  ...
  const videoStyle = {
    ...
    opacity: 0.7,
    filter:
      'saturate(0.4) brightness(2.9) contrast(0.3) sepia(0.2) hue-rotate(-30deg)',
  };
