...
const DigitalClock: React.FC = () => {
  ...
  const entranceName = useKeyframes(
    'entrance',
    `
  ...
  const groupFloatName = useKeyframes(
    'groupFloat',
    `
  ...
  const rainbowGlowName = useKeyframes(
    'rainbowGlow',
    `
  ...
  const cosmicDriftName = useKeyframes(
    'cosmicDrift',
    `
  ...
  const twinkleName = useKeyframes(
    'twinkle',
    `
    0%, 100% { opacity: 0.2; }
    50% { opacity: 0.3; }
  ...
  const auroraSweepName = useKeyframes(
    'auroraSweep',
    `
