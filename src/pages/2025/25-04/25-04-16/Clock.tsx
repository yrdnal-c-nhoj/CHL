...
const BirthdayCakeClock = () => {
    ...
    const handImgStyle: React.CSSProperties = {
        position: 'absolute',
        top: '50%',
        left: '50%',
    ...
    const hourImgStyle: React.CSSProperties = {
        ...handImgStyle,
        height: '34vh',
    ...
    const minuteImgStyle: React.CSSProperties = {
        ...handImgStyle,
        height: '44vh',
        zIndex: 6,
    };
    ...
    const fullPageImageStyle: React.CSSProperties = {
        position: 'fixed',
        top: 0,
        left: 0,
        width: '100vw',
    ...
    const fullPageImage2Style: React.CSSProperties = {
        ...fullPageImageStyle,
        zIndex: 2,
        filter: 'saturate(200%)',
    };
