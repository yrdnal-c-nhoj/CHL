...
const CloudyNightClock: React.FC = () => {
    ...
    const bttitleStyle: React.CSSProperties = {
    ...
    const clocknameStyle: React.CSSProperties = {
        fontFamily: '"Oxanium", serif',
        position: 'fixed',
        left: '50%',
        transform: 'translateX(-50%)',
    ...
    const dateLeftStyle: React.CSSProperties = {
        fontSize: '3vh',
    ...
    const dateRightStyle: React.CSSProperties = {
        fontSize: '3vh',
        fontFamily: '"Nanum Gothic Coding", monospace',
        position: 'absolute',
        right: 0,
