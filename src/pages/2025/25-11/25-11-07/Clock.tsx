...
const PanicAnalogClock: React.FC = () => { // Standardized font loading with font-display: swap to avoid FOUC
    ...
    const stoneClockStyle: React.CSSProperties = {
        position: 'absolute',
        bottom: '2vh',
        left: 0,
        right: 0,
    ...
    const rockDigitStyle: React.CSSProperties = {
    ...
    const rockPunctStyle: React.CSSProperties = {
        display: 'inline-block',
        opacity: 0.6,
        padding: '0 0.05em',
    };
            ...
            {fontUrl && showImages.right && (
                <div style={stoneClockStyle}>
                    {Array.from(timeStr).map((ch, idx) => {
                        ...
                        const perDigitStyle: React.CSSProperties = {
                            ...rockDigitStyle,
...
export default PanicAnalogClock;
