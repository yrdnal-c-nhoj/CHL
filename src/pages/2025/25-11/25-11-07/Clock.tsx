...
const PanicAnalogClock =  () => {
  ...
  const stoneClockStyle = {
    ...
    fontSize: '10dvh',
    lineHeight: 1,
    letterSpacing: '0.6dvh',
    opacity: 0.9,
    userSelect: 'none',
    textShadow: '0.6dvh 1dvh 2dvh rgba(0,0,0,0.7)',
    transform: 'perspective(80dvh) rotateX(10deg) rotateY(-5deg) scale(1.02)',
  ...
  const rockDigitStyle = {
    ...
    textShadow: [
      '1.7dvh 1.8dvh 0 rgba(0,0,0,0.9)',
      '0.28dvh 0.28dvh 0 rgba(255,255,255,0.6)',
      '-0.2dvh -0.2dvh 0 rgba(0,0,0,0.65)',
      '0 1.6dvh 2.8dvh rgba(0,0,0,0.9)',
    ].join(', '),
