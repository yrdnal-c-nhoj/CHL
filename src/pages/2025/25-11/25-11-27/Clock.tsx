...
import revolution251127font from '@/assets/fonts/25fonts/25-11-27-dec.ttf?url';
import line251127font from '@/assets/fonts/25fonts/25-11-27-french.ttf?url';
import hourHandImg from '@/assets/images/25_images/25-11/25-11-27/fre.webp';
import minuteHandImg from '@/assets/images/25_images/25-11/25-11-27/fren.webp';
...
export default function Clock() {
  ...
  const clockTime = useSmoothClock(50);
