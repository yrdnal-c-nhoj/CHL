...
const Clock: React.FC<ClockProps> = ({
    ...
    const timerDigitBoxStyle: React.CSSProperties = {
    ...
    const timerDotBoxStyle: React.CSSProperties = {
        ...timerDigitBoxStyle,
        width: '0.08vh',
        minWidth: '0.08vh',
        padding: 0,
    ...
    const renderTimerBoxed = (ms) => {
        ...
        const s: Record<string, React.CSSProperties> = Math.floor(totalSeconds % 60);
