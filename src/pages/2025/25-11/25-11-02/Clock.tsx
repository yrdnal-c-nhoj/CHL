...
const timeRowStyle = (fontSize, opacity = 1): React.CSSProperties => ({
    fontSize,
    fontWeight: 'bold',
...
const MonarchScene: React.FC = () => { // Standardized font loading with font-display: swap to avoid FOUC
    const fontConfigs = [
        {
    ...
    const s: Record<string, React.CSSProperties> = String(time.getSeconds()).padStart(2, '0');
