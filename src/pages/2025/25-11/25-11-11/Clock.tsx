...
const CustomFontMirroredClock: React.FC = () => { // Use Suspense loader for fonts
  ...
  `;
    ...
    const mirroredClockStyle: React.CSSProperties = {
...
export default CustomFontMirroredClock;
