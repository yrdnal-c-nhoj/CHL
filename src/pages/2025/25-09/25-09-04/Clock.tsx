...
const AnalogClock: React.FC = () => {
    ...
    const brassGradient = (angle = '45deg') => ({
        ...
        boxShadow:
            '0 0 0.15rem rgba(255, 255, 255, 0.5), inset 0 0.05rem 0.1rem rgba(255,255,255,0.4)',
    });

    // Adjust handStyle so hour hand is closer to center
    const handStyle = (width, height, origin, offset = 6): React.CSSProperties => ({
        position: 'absolute',
        width,
        height,
        borderRadius: '0.5rem',
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <div style={handStyle('1.4rem', '11rem', 'center 2rem', 6)} />{' '}
