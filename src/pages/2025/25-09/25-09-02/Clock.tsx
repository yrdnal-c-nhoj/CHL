...
const FullViewportRectangularAnalogClock: React.FC = () => {
    ...
    const svgStyle: React.CSSProperties = { display: 'block', width: '100%', height: '100%' };
...
export default FullViewportRectangularAnalogClock;
