...
import fontFile from '@/assets/fonts/25fonts/25-12-26-sat.ttf?url';
export const assets = [bgImage, overlayImage, fontFile];
 // ?url tells Vite to copy the file to output
