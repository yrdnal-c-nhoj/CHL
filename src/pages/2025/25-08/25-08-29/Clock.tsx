...
const AnalogClock: React.FC = () => {
    ...
    // Hands
    const handStyle = (deg, widthVw, color, zIndex = 5, length = '45%'): React.CSSProperties => ({
        position: 'absolute',
        top: '50%',
        left: '50%',
        width: widthVw,
    ...
    // Digit image style
    const numberStyle = (deg): React.CSSProperties => ({
        position: 'absolute',
        top: '50%',
        left: '50%',
        width: '5vw',
    ...
    const counterweightStyle: React.CSSProperties = {
        position: 'absolute',
        top: '50%',
        left: '50%',
        width: '1vw',
