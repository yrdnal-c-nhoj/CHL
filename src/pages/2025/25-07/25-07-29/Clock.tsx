...
const SlotMachineClock: React.FC = () => {
    ...
    const [reelContents, setReelContents] = useState<any>([[], [], []]); // Store content for each reel
    const [bgContents, setBgContents] = useState<any>([[], [], []]); // Store background content for each reel
...
const styleElement: React.CSSProperties = document.createElement('style');
