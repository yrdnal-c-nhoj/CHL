...
const PrimaryColorClock: React.FC = () => {
    ...
    const [handColors, setHandColors] = useState<any>({
        second: COLORS[0],
        minute: COLORS[1],
        hour: COLORS[2],
    });
  ...
  `;
    ...
    const styleTag: React.CSSProperties = <style>{fontFace}</style>;
    ...
    const bgStyle1: React.CSSProperties = {
        position: 'fixed',
        top: 0,
        left: 0,
        width: '150vw',
    ...
    const minHandStyle: React.CSSProperties = {
        ...baseHandStyle,
        height: '9vh',
        width: '100%',
