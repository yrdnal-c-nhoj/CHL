    ...
    <div className="container">
      ...
      <div className="centeredContent">
        ...
        <div className="manifestoSection">
          ...
          <p><span className="hat">We Love Typefaces<br />&nbsp;</span>
          ...
          <p><span className="hat">We Use AI<br />&nbsp;</span>
          ...
          <p><span className="hat">Plus Ars Citius Omni Tempore Nam Quisque*<br />&nbsp;</span>
